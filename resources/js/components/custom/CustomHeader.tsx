        ...
        <>
            <div className="border-sidebar-border/80 border-b">
                <div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                        ...
                        <Sheet>
                            ...
                            <SheetContent side="left" className="bg-sidebar flex h-full w-64 flex-col items-stretch justify-between">
                                ...
                                <SheetHeader className="flex justify-start text-left">
                                    <CustomLogo logo={WebLogo} className="h-9 fill-current text-black dark:text-white" />
                                </SheetHeader>
                    ...
                    <Link href="landing" prefetch className="flex items-center space-x-2">
                        <CustomLogo logo={WebLogo} className="mx-2 h-9" />
                    </Link>
                    ...
                    <div className="ml-auto flex items-center">
                        ...
                        {auth.user ? (
                            ...
                            // Render Sign Up and Log In buttons if the user is not logged in
                            <div>
                                <Button variant="customized" className="w-24">
                                    Sign up
                                </Button>
                                <Button variant="customized" className="w-24">
                                    Log in
