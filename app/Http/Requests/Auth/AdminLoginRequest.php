...
class AdminLoginRequest extends FormRequest
{
    ...
    public function authenticate(): void
    {
        ...
        if ($admin->status_id != 3) {
            ...
            throw ValidationException::withMessages([
                'admin_username' => 'Your account is inactive. Please contact your Barangay office.',
            ]);
        }
    ...
    public function ensureIsNotRateLimited(): void
    {
        ...
        throw ValidationException::withMessages([
            'admin_username' => __('auth.throttle', [
                'seconds' => $seconds,
    ...
    {
        return Str::transliterate(Str::lower($this->string('admin_username')) . '|' . $this->ip());
    }
}
